package com.github.linyp.shiro.chapter10.session.scheduler;

import com.github.linyp.shiro.chapter10.JdbcTemplateUtils;
import com.github.linyp.shiro.chapter10.SerializableUtils;
    ...
    public void run() {
        ...
        while(sessionList.size() > 0) {
            for(String sessionStr : sessionList) {
                try {
                    Session session = SerializableUtils.deserialize(sessionStr, Session.class);
